...
public class ImportExportImage {
    ...
    /**
     * Generates a RGB buffered image of specified size,
     * with each pixel set to given color
     *
     * @param width  Width of image to be generated
     * @param height Height of image to be generated
     * @param color  Color at each pixel on image
     * @return Buffered RGB image with pixels set to specified color intensity value
     */
    public static BufferedImage prepareCanvas(int width, int height, Color color) {
        return ImportExportImage.setCanvas(
