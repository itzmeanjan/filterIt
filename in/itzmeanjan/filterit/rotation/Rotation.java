...
/**
 * To be implemented by horizontally & vertically rotating classes or any other utility classes
 * which'll try to rotate image, following two abstract methods will be only way using which user
 * gets to talk to rotation mechanism
 */
