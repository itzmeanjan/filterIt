...
/**
 * Given an image, we'll rotate it by 270° in clockwise direction, using
 * combination of two basic operations
 * 
 * i > First horizontally rotate image matrix ( H )
 * 
 * ii > Then transpose image matrix ( T )
 * 
 * R = result image = T( H ( Image ) )
 * 
 * Note that : Step i & ii needs to be applied in ordered fashion, otherwise
 * that will result into rotating image by 90° in clockwise direction
 */
