...
public class GrayScale {
  ...
  /**
   * Given one already imported image i.e. contructed BufferedImage object, we'll compute grayscaled
   * image in another BufferedImage instance, which is to be returned
   */
  ...
  /**
   * Reads content of source image, grayscales image and writes output into a BufferedImage object,
   * which is to be returned, can be used for further processing
   */
